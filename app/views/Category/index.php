        ...
        <div class='lightBackground'>
          ...
          <div class="fixTableHead">
            <table>
              ...
              <tbody>
                <?php
                echo"<form id='catEdit' action='/Category/edit'>";
                  foreach($data['categorys'] as $item)
                  {
                    echo"  
                        <tr>
                          <td>
                              <input style='border:none; text-align:center;' class='catName' name='category_id_$item->category_id' value='$item->name' onfocusout='editCat($item->category_id)'></input>
                          </td>
                          <td id='totalS'>$item->totalS</td>
                          <td>$item->totalP</td>
                          <td><button onclick='confirm($item->category_id, event)' class='btn btn-danger' id='deleteBut'>Delete</button></td>
                        </tr>
                      ";
                  }
