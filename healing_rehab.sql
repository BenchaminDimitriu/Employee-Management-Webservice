...
(86, 'phyto mist 50m', 5, 43, 60.72, NULL),
(87, 'UV Physical Tinted SPF 41', 10, 65, 75.45, NULL),
(92, 'xxx', 11, 190, 300, 65);
...
--
ALTER TABLE `summary`
  MODIFY `summary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=263;
